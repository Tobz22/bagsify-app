  ...
  return (
    <div>
      ...
      <div className='container my-5 '>
        <h2 className='text-center fw-bold mb-4'>❤️ Wishlist</h2>
        {wishlist.length === 0 ? (
          <div className='text-center'>
            <p className='lead text-muted'>Your Wishlist is Empty.</p>
            <Link to='/shop' className='cart-btn'>
              <i className='ri-shopping-bag-line me-2'></i>Broswer Products
            </Link>
          </div>
        ) : (
                ...
                <div className='card h-100 shadow-sm border-0'>
                  ...
                  <div className='card-body d-flex flex-column text-center'>
                    ...
                    <div className='mt-auto d-grid gap-2 '>
                      ...
                      >
                        <i className='ri-shopping-cart-2-line me-1'></i>Add To
                        Cart
                      </button>
                      <button
                        className='btn-remove-cart w-100'
                        onClick={() => removeFromWishlist(product.id)}
                      >
                        <i className='ri-shopping-cart-2-line me-1'></i>Remove
                      </button>
                    </div>
                  </div>
                </div>
